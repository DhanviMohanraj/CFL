"""
Unit tests for DriftInjector component.
Validates linguistic replacement rules, protocol change-points,
and deterministic behavior independent of real datasets.
"""
